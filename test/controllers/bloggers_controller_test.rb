...
class BloggersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create blogger" do
    assert_difference('Blogger.count') do
      post bloggers_url, params: { blogger: { ArticleBody: @blogger.ArticleBody, ArticleTitle: @blogger.ArticleTitle, Name: @blogger.Name } }
    end
  ...
  test "should update blogger" do
    patch blogger_url(@blogger), params: { blogger: { ArticleBody: @blogger.ArticleBody, ArticleTitle: @blogger.ArticleTitle, Name: @blogger.Name } }
